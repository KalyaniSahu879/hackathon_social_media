...
const Post = ({post}) => {
    ...
    useEffect (()=>{
        const fetchUser = async () => {
          ...
          await axios.get(`https://hackthon-backend-soc.herokuapp.com/api/users?userId=${post.userId}`)
          .then((res)=>{
    ...
    const likeHandler = async()=>{
        try{
            ...
            await axios.put('https://hackthon-backend-soc.herokuapp.com/api/posts/'+post._id+'/like' , {userId:currentUser._id})
        }catch(err){
            console.log(err)
        }
        ...
        <div className="postWrapper">
            <div className="postTop">
                <div className="topLeft">
                    ...
                    <img src={user.profilePicture || mopp } alt="" className="postProfileImg" />
                    </Link>
